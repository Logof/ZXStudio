...
pub fn render_font_editor(
    ...
    ui.horizontal(|ui| {
        ...
        ui.vertical(|ui| {
            ...
            // ============================================================================
            // ИСПРАВЛЕНО: Для egui::Frame задана принудительная минимальная высота,
            // а внутренний ScrollArea увеличен до 620.0 пикселей.
            // Теперь фрейм со списком кнопок стал значительно выше и идеально выровнен!
            // ============================================================================
            egui::Frame::group(ui.style())
                .inner_margin(6.0)
                .show(ui, |ui| {
                    ui.set_height(620.0); // Задаем жесткую высоту фрейма-группы

                    egui::ScrollArea::vertical()
                        .id_source("font_selector_scroll")
                        .max_height(610.0) // Увеличиваем высоту прокрутки, чтобы занять весь фрейм
                        .auto_shrink([false; 2])
                        .show(ui, |ui| {
                            // Сетка по 8 иконок в ряд
